...
pub use traits::{AxisExtreme, BSplineEnd, EdgeSelector, ProfileOrient, SweepTransition, Tessellation};
...
impl Solid {
	...
	pub fn fillet_selected_edges(&self, radius: f64, selector: EdgeSelector) -> Result<crate::Solid, Error> {
		<Self as crate::traits::SolidStruct>::fillet_selected_edges(self, radius, selector)
	}
	...
	pub fn chamfer_selected_edges(&self, distance: f64, selector: EdgeSelector) -> Result<crate::Solid, Error> {
		<Self as crate::traits::SolidStruct>::chamfer_selected_edges(self, distance, selector)
	}
	...
	pub fn sweep_with_transition<'a, 'b, 'c>(profile: impl IntoIterator<Item = &'a Edge>, spine: impl IntoIterator<Item = &'b Edge>, orient: ProfileOrient<'c>, transition: SweepTransition) -> Result<crate::Solid, Error> {
		<Self as crate::traits::SolidStruct>::sweep_with_transition(profile, spine, orient, transition)
	}
