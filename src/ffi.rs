...
mod ffi_bridge {
	...
	unsafe extern "C++" {
		...
		fn make_pipe_shell(all_edges: &CxxVector<TopoDS_Edge>, spine_edges: &CxxVector<TopoDS_Edge>, orient: u32, ux: f64, uy: f64, uz: f64, aux_spine_edges: &CxxVector<TopoDS_Edge>, transition: u32) -> UniquePtr<TopoDS_Shape>;
